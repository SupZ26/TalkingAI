...
export default {
  ...
  methods: {
    init(){
        ...
        axios.get("/api/accounts/findAllDetails",{
            headers:{
    ...
    onSubmit(){
     ...
     restName(){
        ...
        axios.put("/api/accounts/updateUsername?oldUsername=" + this.username + "&newUsername=" + this.form.username, null, {  
            headers: {  
                'Authorization': "Bearer " + JSON.parse(sessionStorage.getItem("authorize")).token  
            }  
        }).then(res => {  
     ...
     restPassword(){
        ...
        axios.put("/api/accounts/updatePassword?userId=" + this.userId, 
            {  
                oldPassword: this.password1,  
                newPassword: this.password  
            } ,
